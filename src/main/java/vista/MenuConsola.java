...
public class MenuConsola {
    ...
    private void editarCampana() {
        System.out.print("Ingrese ID de la Campaña a editar: ");
        ...
        if (c != null) {
            ...
            // Nombre
            System.out.print("Nuevo Nombre [" + c.getNombreCampaña() + "]: ");
            String n = leer.nextLine();
            if (n.isEmpty()) n = c.getNombreCampaña();

            // Ubicación
            System.out.print("Nueva Ubicación [" + c.getUbicacion() + "]: ");
            ...
            System.out.print("Nueva Fecha [" + fechaActual + "]: ");
            String f = leer.nextLine();
            if (f.isEmpty()) f = fechaActual;

            // Meta
            System.out.print("Nueva Meta [" + c.getMetaDonaciones() + " ml]: ");
...
// Metodos de extracciones
    ...
    System.out.print("ID de la Campaña: "); String id = leer.nextLine();
    System.out.print("RUT actual del Donante: "); String rutV = leer.nextLine();
    ...
    private void eliminarExtraccion() {
        System.out.print("ID de la Campaña: "); String id = leer.nextLine();
        System.out.print("RUT del Donante: "); String rut = leer.nextLine();
